#!/bin/bash
#SBATCH --job-name=diabetic_exp2_generate_fix_trace
#SBATCH --ntasks=1
...
config=/p/citypm/AIFairness/Counterfactual_Explanation/diabetic_experiments_exp23_generate_fix_trace.txt
